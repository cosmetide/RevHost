...
void UIController::postInit()
{
	...
	NavigateToScene(0, eUIScene_MainMenu);
}
...
#else
	case eFont_Japanese:		return new UITTFFont("Mojangles_TTF_jaJP", "resources/Common/Media/font/JPN/DFGMaruGothic-Md.ttf", 0x2022); // JPN
#ifdef _DURANGO
	case eFont_SimpChinese:		return new UITTFFont("Mojangled_TTF_cnCN", "resources/Common/Media/font/CHS/MSYH.ttf", 0x2022); // CHS
#endif
	case eFont_TradChinese:		return new UITTFFont("Mojangles_TTF_cnTD", "resources/Common/Media/font/CHT/DFHeiMedium-B5.ttf", 0x2022); // CHT
	case eFont_Korean:			return new UITTFFont("Mojangles_TTF_koKR", "resources/Common/Media/font/KOR/BOKMSD.ttf", 0x2022); // KOR
#endif
